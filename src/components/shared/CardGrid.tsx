      ...
      {items.map((card, index) => {
        ...
        return (
          <motion.div
            ...
            className={`group relative rounded-2xl p-5 sm:p-6 lg:p-8 transition-all duration-500 ${
              variant === "glass" 
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-foreground font-display group-hover:text-accent transition-colors duration-300">
                {card.title}
              </h3>
